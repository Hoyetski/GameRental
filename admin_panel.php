...
<body>
    <div class="panel_container">
        <header>
            <img src="./assets/GameRental_logo.png" alt="GameRental logo" height="40px">
        </header>
        <section>
            <h2>Sekcja wypożyczania gier</h2>
                <form action="./scripts/add_rental.php" method="post">
        ...
        <section>
            ...
            <?php include('./includes/display_rentals.php'); ?>
        </section>
        <section>
            <h2>Sekcja dostępnych gier</h2>
            <?php include('./includes/display_games.php'); ?>
        </section>
        <section>
        ...
        <section>
            ...
            <?php include('./includes/display_clients.php'); ?>
        </section>
        <section>
            <h2>Sekcja dodawania klientów</h2>
                <form action="./scripts/add_client.php" method="post">
